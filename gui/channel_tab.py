...
class ChannelsTab(ctk.CTkFrame):
    def __init__(self, master, on_selection_changed=None, **kwargs):
        ...
        self.search_entry = ctk.CTkEntry(
            self, placeholder_text="Type to search...", width=-220
        )
        ...
        clear_numbers_btn = ctk.CTkButton(
            self,
            text="Clear Numbers",
            fg_color="#7a0e02",
            hover_color="red",
        ...
        deleted_selected_rows_btn = ctk.CTkButton(
            self,
            text="Delete Selected Numbers",
            corner_radius=8,
            fg_color="#7a0e02",
            hover_color="red",
            command=self.del_selected_number,
            font=("arial", 12, "bold"),
        )
    ...
    def open_only(self):
        ...
        threading.Thread(
            target=self.whatsapp_sender.open_browser_only,
            args=(selected_numbers,),
            daemon=True,
        ).start()
